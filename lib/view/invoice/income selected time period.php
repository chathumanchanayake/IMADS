...
<div class="no-print">
        ...
        <div class="form-group row">
                ...
                <div class="col-2 px-4 py-2">
                    <button type="button" class="btn btn-success" id="genarate">Generate</button>
                </div>
            </div>
        </div>
</div>
...
<div class="container" style="background-color:white;  color: black;">
    ...
    <h2 class="py-3" style="text-align:center">Custom Generated Report-products</h2>
...
$(function() {
    $('input[name="daterange"]').daterangepicker({
        opens: 'left',
        endDate: moment().subtract(1, 'days'), // Disable future dates
