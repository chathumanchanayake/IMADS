...
<head>
  ...
  border: 1px solid;
    ...
    <title class='no-print'>Delivery Information</title>
</head>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="form-group px-5 py-2">
                ...
                <button type="" class="btn btn-success disabled" style="align:right" id="next1">Confirm Delivery
                    Details</button>
                <button type="" class="btn btn-success disabled" id="next2">checkout</button>
                <button type="" class="btn btn-success" id="next4">checkout</button>
                <button type="" class="btn btn-success noprint"  id="next3">Back to Shopping</button>
...
<script>
  ...
  if (checkBox.checked == true && $("#address_Name").val() != ""){
