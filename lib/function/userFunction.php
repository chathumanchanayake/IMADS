...
public function userRegistration($name,$email,$pwd,$phone,$nic){
  ...
  if($sqlResult > 0){
      ...
      $email_send = new Mail();
      $email_send->Send_mail($email,"Welcome to DREAMY BOOKS","<h3>Hellow $name,</h3><br> <h4>Click this link to Activate your Account, <h4> <br> http://127.0.0.1/dreamy/lib/routes/users/activate.php?id=$userId&token=$token ");
...
//   } else {
//     $("#userEmail").attr('value', "Please Enter a Valid Email");
//     $("#userEmail").attr('class', "form-control is-invalid");
//   }
// }
